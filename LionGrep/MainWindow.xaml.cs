...
public sealed partial class MainWindow : Window
{
    ...
    {
        var picker = new Windows.Storage.Pickers.FileSavePicker { SuggestedFileName = "liongrep-results.csv" };
    ...
    private async void OnOpenInExcel(object sender, RoutedEventArgs e)
    {
        var temp = System.IO.Path.Combine(System.IO.Path.GetTempPath(),
            $"liongrep-{DateTime.Now:yyyyMMdd-HHmmss}.xlsx");
        try
        {
...
#pragma warning restore IDISP004
    ...
    private static void WriteXlsx(string path, IReadOnlyList<FileMatchViewModel> files)
    {
        ...
        var ws = wb.Worksheets.Add("LionGrep results");
...
#pragma warning restore VSTHRD101
    ...
    private async Task SaveCurrentAsPresetAsync()
    {
        ...
        void Revalidate()
        {
            ...
            {
                if (HotkeyParser.IsReserved(hk)) hkErr = "Reserved by LionGrep (Search / Replace).";
