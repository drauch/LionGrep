...
public sealed partial class SettingsWindow : Window
{
    ...
    public SettingsWindow(nint ownerHwnd, LionGrep.Models.Preset? addTemplate = null)
    {
    ...
    private async void OnResetEverythingClicked(object sender, RoutedEventArgs e)
    {
        var dialog = new ContentDialog
        {
            ...
            Content = "This erases all LionGrep settings, presets, and recently used values "
    ...
    // LionGrep registry root captured verbatim). We save it with a `.reg.ini` extension so a stray
    ...
    private async void OnExportSettingsClicked(object sender, RoutedEventArgs e)
    {
        ...
        var picker = new FileSavePicker
        {
            ...
            SuggestedFileName = "liongrep-settings",
        ...
        var tempReg = Path.Combine(Path.GetTempPath(), $"liongrep-export-{System.Guid.NewGuid():N}.reg");
        try
        {
    ...
    private async void OnImportSettingsClicked(object sender, RoutedEventArgs e)
    {
        ...
        var confirm = new ContentDialog
        {
            ...
            Content = $"This will overwrite ALL of your current LionGrep settings — presets, recently used "
        ...
        var tempReg = Path.Combine(Path.GetTempPath(), $"liongrep-import-{System.Guid.NewGuid():N}.reg");
        try
        {
            ...
            await ShowMessageAsync("Settings imported",
                "Restart LionGrep for the imported settings to take effect.");
